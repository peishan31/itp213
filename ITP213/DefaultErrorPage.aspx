<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="DefaultErrorPage.aspx.cs" Inherits="ITP213.DefaultErrorPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p> <!--3. This is where you code all your features-->
        ...
        <!-- Page Content -->
          ...
          <p class="lead">An error has occured. You can
